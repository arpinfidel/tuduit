...
// NewDefault returns a new Argon2idHash
// with default values.
...
func (a *Argon2idHash) Compare(hash, salt, password []byte) (match bool, err error) {
	...
	return bytes.Equal(hash, hashSalt.Hash), nil
}
